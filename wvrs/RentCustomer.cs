...
namespace wvrs
{
    class RentCustomer
    {
        ...
        public RentCustomer(string tranno, string trandt, TouristCust cust, Vehicle veh, int daysrented,
            int actualrentdays=0, string actualreturndt="", double rentamount=0.0,
        ...
        public void ReturnVehicle(string returndt, double damagecost)
        {
            ...
            this.vatamount = 0.12 * this.rentamount;
        ...
        public string RentRecipt()
        {
            ...
            msg += "Customer ID : " + this.cust.CustID + "\t" + "Customer Name : " + this.cust.FullName + "\n";
        ...
        public string ToCSVString()
        {
            ...
            msg = this.tranno + "," + this.trandt + "," + this.cust.CustID + "," + this.veh.VehRegNo + "," +
